...
with gzip.open("/cluster/projects/schwartzgroup/fatema/find_ccc/" + options +'_'+'_cellvsgene_'+ 'not_quantileTransformed', 'wb') as fp:
...
random_activation = []
with gzip.open("/cluster/projects/schwartzgroup/fatema/find_ccc/" + options + '_ground_truth_ccc', 'wb') as fp:  # at least one of lig or rec has exp > respective knee point          
