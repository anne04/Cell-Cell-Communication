...
parser.add_argument( '--data_name', type=str, default='synthetic_data_mixture_mechanistic_noise0', help='The name of dataset')
...
options = 'mixture_mechanistic_noise'+str(noise_percent)+'level'+str(noise_add)
...
random_activation = []
with gzip.open("/cluster/projects/schwartzgroup/fatema/find_ccc/" + options + '_grpund_truth', 'wb') as fp:  # at least one of lig or rec has exp > respective knee point          
