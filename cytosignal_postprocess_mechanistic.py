...
datapoint_size_list = [3000, -1, -1, 3000, -1, -1,  5000]
options_list = ['equidistant_mechanistic_noise0', '', '', 'uniform_mechanistic_noise0', '', '', 'mixture_mechanistic_noise0', '', ''] 
...
for sample_type in [0, 3, 6]: #len(options_list)):
    print('%d'%sample_type)
