...
def get_dataset(
    ...
    record_index = []
    for i in range (i_start, i_start+len(ccc_pairs)):
        #print(i)
...
if __name__ == "__main__":
    ...
    ccc_pairs = ccc_pairs.iloc[0:lymph_start_index]
    ...
    parser.add_argument( '--barcode_info_gene_path', type=str, default='metadata/LRbind_V1_Human_Lymph_Node_spatial_1D_manualDB_geneLocalCorrKNN_bidir/LRbind_V1_Human_Lymph_Node_spatial_1D_manualDB_geneLocalCorrKNN_bidir_barcode_info_gene', help='Name of the dataset') 
    parser.add_argument( '--barcode_info_path', type=str, default='metadata/LRbind_V1_Human_Lymph_Node_spatial_1D_manualDB_geneLocalCorrKNN_bidir/LRbind_V1_Human_Lymph_Node_spatial_1D_manualDB_geneLocalCorrKNN_bidir_barcode_info', help='Name of the dataset')    
    ...
    parser.add_argument( '--gene_emb_path', type=str, default='embedding_data/LRbind_LUAD_1D_manualDB_geneLocalCorrKNN_bidir/model_LRbind_LUAD_lymph_1D_manualDB_geneLocalCorrKNN_bidir_3L_negatome_r1_LYMPH_Embed_X', help='Name of the dataset')
    parser.add_argument( '--protein_emb_path', type=str, default='database/ligand_receptor_protein_embedding.pkl', help='Name of the dataset')
    args = parser.parse_args()
    ...
    ccc_pairs = pd.read_csv(args.lr_lrbind_csv_path, sep=",")
    # ccc_pairs = ['from_cell', 'to_cell', 'from_gene_node', 'to_gene_node', 'ligand_gene', 'rec_gene']                            
    ccc_pairs = ccc_pairs.iloc[lymph_start_index:]
    ...
    dataset2, record_index2 = get_dataset(ccc_pairs, cell_vs_gene_emb, gene_node_list_per_spot, X_protein_embedding, 6365547)
    print(len(dataset2))

    for i in range(0, len(dataset2)):
    # add these to dataset
        dataset.append(dataset2[i])
        record_index.append(record_index2[i])
    ...
    with gzip.open('database/'+'model_LRbind_LUAD_lymph_1D_manualDB_geneLocalCorrKNN_bidir_3L_negatome'+'_dataset_results_to_embFusion.pkl', 'wb') as fp:
