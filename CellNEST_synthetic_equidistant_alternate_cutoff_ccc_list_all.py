...
########################################################################################
old_dataname = ['noise0', 'noise30_heavyNoise', 'noise30_lowNoise']
noise_type = ['no_noise', 'low_noise', 'high_noise']
nest_model_noise_type = ['', 'lowNoise_','heavyNoise_']
# ls /cluster/projects/schwartzgroup/fatema/find_ccc/*synthetic_data_ccc_roc_control_model_dt-path_equally_spaced_lrc1467_cp100_*_random_overlap_knn10*
for sample_type in range (0, len(noise_type)):
    with gzip.open("/cluster/projects/schwartzgroup/fatema/find_ccc/synthetic_data_ccc_roc_control_model_dt-path_equally_spaced_lrc1467_cp100_"+ old_dataname[sample_type] +"_random_overlap_knn10_cellCount3000_3dim_3patterns_temp_xny" , 'rb') as fp: #datatype
    ...
    with gzip.open("/cluster/projects/schwartzgroup/fatema/find_ccc/Tclass_synthetic_data_ccc_roc_control_model_dt-path_equally_spaced_lrc1467_cp100_"+ old_dataname[sample_type] +"_random_overlap_knn10_cellCount3000_3dim_3patterns_temp" , 'rb') as fp:            
    ...
    with gzip.open("/cluster/projects/schwartzgroup/fatema/find_ccc/adjacency_records_synthetic_data_ccc_roc_control_model_dt-path_equally_spaced_lrc1467_cp100_"+ old_dataname[sample_type] +"_random_overlap_knn10_cellCount3000_3dim_3patterns_temp" , 'rb') as fp:  # +'_'+'notQuantileTransformed'at least one of lig or rec has exp > respective knee point          
