...
# prob_thresh=0.8, 0.75
labels, polys = model.predict_instances_big(img, axes='YXC', block_size=4096, prob_thresh=0.7,nms_thresh=0.001, min_overlap=128, context=128, normalizer=None, n_tiles=(4,4,1))
