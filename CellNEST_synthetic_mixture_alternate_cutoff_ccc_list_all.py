...
nest_model_noise_type = ['', 'lowNoise_','highNoise_']
...
for sample_type in range (0, len(noise_type)):
    ...
    with gzip.open("/cluster/projects/schwartzgroup/fatema/find_ccc/Tclass_synthetic_data_ccc_roc_control_model_dt-path_mixture_of_distribution_lrc112_cp100_"+ old_dataname[sample_type] +"_random_overlap_threshold4_cellCount5000_3dim_3patterns_temp" , 'rb') as fp:            
    ...
    with gzip.open("/cluster/projects/schwartzgroup/fatema/find_ccc/adjacency_records_synthetic_data_ccc_roc_control_model_dt-path_mixture_of_distribution_lrc112_cp100_"+ old_dataname[sample_type] +"_random_overlap_threshold4_cellCount5000_3dim_3patterns_temp" , 'rb') as fp:  # +'_'+'notQuantileTransformed'at least one of lig or rec has exp > respective knee point          
...
#######################################
    ...
    df.to_csv('/cluster/projects/schwartzgroup/fatema/find_ccc/synthetic_data/type_mixed_distribution/'+ noise_type[sample_type] +'/ccc_list_all_'+ model_type +'.csv', index=False, header=False)
